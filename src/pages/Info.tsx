    ...
    <div className="space-y-8 p-4">
      ...
      <Card>
        ...
        <CardContent className="space-y-4 text-text-light"> 
          <p>This application allows you to predict the podium (top 3 drivers) for each Formula 1 Grand Prix. Compete with your friends and other users to see who has the best F1 knowledge!</p>
      ...
      <Card>
        ...
        <CardContent className="space-y-4 text-text-light"> 
          <p>Points are awarded based on the accuracy of your podium prediction for each race:</p>
          <ul className="list-disc list-inside space-y-2">
            ...
            <li><strong>Driver on Podium, but Incorrect Position:</strong>
              <ul className="list-circle list-inside ml-4">
                <li>For each driver you predicted to be on the podium who *is* on the actual podium, but in a different position: <strong className="text-primary">3 points</strong></li>
              </ul>
            </li>
          </ul>
          <p>Example:</p>
          <ul className="list-disc list-inside space-y-2">
            <li>Your Prediction: [VER, PER, LEC]</li>
            <li>Actual Result: [VER, SAI, PER]</li>
            <li>Scoring:
              <ul className="list-circle list-inside ml-4">
